...
let duplicados = lista.filter((nome, index) => lista.indexOf(nome) != index);
console.log("os nomes duplicados são: " + duplicados);
let novaLista = lista.filter((nome, index) => lista.indexOf(nome) == index);
